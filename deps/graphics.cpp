...
void InitGraphics()
{
	...
	GBlurFS.LoadFragmentShader("./shaders/ori/blurfragshader.glsl");
	GSobelFS.LoadFragmentShader("./shaders/ori/sobelfragshader.glsl");
	GMedianFS.LoadFragmentShader("./shaders/ori/medianfragshader.glsl");
	GMultFS.LoadFragmentShader("./shaders/ori/multfragshader.glsl");
	GThreshFS.LoadFragmentShader("./shaders/ori/threshfragshader.glsl");
	GDilateFS.LoadFragmentShader("./shaders/ori/dilatefragshader.glsl");
	GErodeFS.LoadFragmentShader("./shaders/ori/erodefragshader.glsl");
